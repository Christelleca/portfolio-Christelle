...
if (selectedTheme) {
    //If the validation is fulfilled, we ask what the issue was to know if we activated or desactivated thte dark
...
//activate / desactivate the theme manually whit the button
